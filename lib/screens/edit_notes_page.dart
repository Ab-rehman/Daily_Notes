...
class EditNotesPage extends StatelessWidget {
  ...
  static const id = 'edit_notes_page';
  final index;
  var titleText;
  var messageText;
  bool isFirst = true;

  EditNotesPage({this.index, this.titleText, this.messageText});
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (titleController.text != null &&
                        ...
                        Provider.of<NotesData>(context, listen: false).updateDB(
                        ...
                        // Provider.of<NotesData>(context,listen: false).notes[index].timeStamp
                        Navigator.pop(context);
